...
const OrderConfirmModal: React.FC<Props> = props => (
    ...
    >
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          ...
          <View style={styles.viewText}>
            <Text style={styles.subtitle}>Após essa operação o agendamento será confirmado e
              será feita a reserva de valor junto ao seu cartão de crédito. Em caso de cancelamento, taxas poderão ser
              cobradas. Deseja continuar?</Text>
          </View>
